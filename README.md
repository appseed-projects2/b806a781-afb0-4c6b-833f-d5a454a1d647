...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-12 09:20`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b806a781-afb0-4c6b-833f-d5a454a1d647.git
$ cd b806a781-afb0-4c6b-833f-d5a454a1d647
```
